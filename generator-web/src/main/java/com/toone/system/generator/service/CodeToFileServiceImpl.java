...
import com.toone.system.generator.entity.TooneTemplateProcessResult;
import com.toone.system.generator.myUpload.MyUploadFileUtil;
import com.toone.system.generator.myUpload.UploadedInfo;
import com.toone.system.generator.util.FileMd5Util;
import com.toone.system.generator.util.FileUtil;
...
//        files.add(tmpDir);
        for (Map.Entry<String, Object> entry : result.entrySet()) {
            ...
            if (fileValue instanceof TooneTemplateProcessResult) {
                ...
                if ("SchemeDevServer".equals(template.getTemplateGroup())) {
                    var packageName = MapUtil.getString(paramInfo.getOptions(), "packageName");
                    if (org.apache.commons.lang3.StringUtils.isNotBlank(packageName)) {
                        codeFilePath = packageName.replace(".", "/") + "/" + codeFilePath;
                    }
                }
